...
int main(){
    ...
    b.del = 4;
   	b.max_heap_build(b.root);  
    cout<<endl;
    b.show_inorder(b.root);

    b.pity_print(b.root,0);

    b.mim_heap_build(b.root);
    cout<<endl;
